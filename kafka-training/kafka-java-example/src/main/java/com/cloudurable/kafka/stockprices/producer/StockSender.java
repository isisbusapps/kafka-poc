...
public class StockSender implements Runnable{
    ...
    private final StockPrice getStockPriceLow;
    ...
    public StockSender(final String topic,
                       final StockPrice stockPriceHigh,
        ...
        this.getStockPriceLow = stockPriceLow;
    ...
    private ProducerRecord<String, StockPrice> createRandomRecord(final Random random){
        final int dollarAmount = randomIntBetween(random, stockPriceHigh.getDollars(), getStockPriceLow.getDollars());
        final int centAmount = randomIntBetween(random, stockPriceHigh.getCents(), getStockPriceLow.getCents());
